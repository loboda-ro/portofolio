...
export const NavBar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center text-neutral-100 font-sans px-4 py-4 sm:px-6 sm:py-6 md:px-8 md:py-10 bg-gradient-to-b from-black/50 to-transparent">
      <div>
