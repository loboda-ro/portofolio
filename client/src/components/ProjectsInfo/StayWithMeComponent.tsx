...
export const StayWithMeComponent = () => (
  <div className="bg-gradient-to-b from-[#0a2342] via-[#0a2342]/10 to-transparent min-h-screen w-full pt-20">
    ...
    >
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-100 drop-shadow-lg mb-2">StayWithMe</h1>
      <div className="text-base sm:text-lg text-blue-100 mb-4">AI Clone of real person from chat history</div>
      <motion.img
        src={mainScreenshot}
    ...
    >
      <div>
        <div className="mb-6">
          ...
          <div className="text-neutral-100 text-base sm:text-lg">Full-Stack Engineer, Product Lead</div>
        </div>
        <div className="mb-6">
        ...
        <div>
          ...
          <div className="text-neutral-100 text-base sm:text-lg">8 month</div>
        </div>
      </div>
      <div>
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        >
          <img src={profileScreenshot} alt="Main Page" className="rounded-xl shadow-lg border border-white/10 w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto my-6" />
          <div className="text-blue-100 text-xs sm:text-sm mt-2 text-center">Profile Page</div>
        </motion.div>
      </div>
    </motion.section>
    ...
    >
      ...
      <div className="text-blue-100 text-xs sm:text-sm text-center">Cloning a Person</div>
    </motion.section>
